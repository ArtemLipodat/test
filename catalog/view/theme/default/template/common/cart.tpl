<div id="cart" class="btn-group btn-block">
  <button type="button" id="hoverButtonCart" class="btn btn-inverse btn-block btn-lg"><i class="fa fa-shopping-cart"></i> <span id="cart-total"><?php echo $text_items; ?></span></button>
