<?php if($special_timer_status==1 && $special_time_config_featured_product_page==1){ ?><script type="text/javascript">
  ...
  <div class="product-layout col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="product-thumb transition">
      ...
      <div class="caption">
        ...
        <?php if($special_timer_status==1 && $special_time_config_featured_product_page==1 && $product['special']){ ?><div class="time_special"  data-time="<?php echo $product['date_end_special'] ;?>"></div><?php } ?>
