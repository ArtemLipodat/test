    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <h1><?php echo $heading_title; ?></h1><?php if($special_timer_status==1 && $special_time_config_product_page==1 && $special){ ?><div class="time_special"  data-time="<?php echo $date_end_special ;?>"></div><?php } ?>
...
//--></script>
<?php echo $footer; ?><?php if($special_timer_status==1 && $special_time_config_product_page==1){ ?><script type="text/javascript">
$(document).ready(function(){
