          ...
          <div class="product-thumb">
            ...
            <div>
              <div class="caption">
                ...
                <?php if($special_timer_status==1 && $special_time_config_special_product_page==1 && $product['special']){ ?><div class="time_special"  data-time="<?php echo $product['date_end_special'] ;?>"></div><?php } ?>
...
<?php echo $footer; ?><?php if($special_timer_status==1 && $special_time_config_special_product_page==1){ ?><script type="text/javascript">
